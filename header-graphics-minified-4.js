! function () {
            ...
            function i() {
                if (f.clearRect(0, 0, s, h), f.fillStyle = t.colorBG, f.fillRect(0, 0, s, h), $ > d) {
                    ...
                    for (let l = 0; l < a.length; l++) {
                        let r = a[l];
                        r.active && !r.appear && r.distToPoint < n && Math.random() > .5 && (r.appear = !0, d++)
                    }
    ...
    class m {
        ...
        show() {
            ...
            this.active && (e = (this.x - n) * o, i = this.y * o + l, s = this.w * o, h = this.h * o, a = t.cornerRadius / t.scaleDownGraphics * o, r = this.neighbours, f.beginPath(), r.west || r.north || r.northWest && !r.north && !r.west ? W(e, i, s, h, 0, 0) : W(e, i, s, h, a, 0), r.east || r.north || r.northEast && !r.north && !r.east ? W(e, i, s, h, 0, 1) : W(e, i, s, h, a, 1), r.east || r.south || r.southEast && !r.south && !r.east ? W(e, i, s, h, 0, 2) : W(e, i, s, h, a, 2), r.west || r.south || r.southWest && !r.south && !r.west ? W(e, i, s, h, 0, 3) : W(e, i, s, h, a, 3), r.west || r.north || r.northWest && !r.north && !r.west ? f.lineTo(e, i) : f.lineTo(e, i + a), f.closePath(), P(), c = (this.x - n) * o, $ = this.y * o + l, d = this.w * o, u = this.h * o, g = t.connectionRadius / t.scaleDownGraphics * o, (_ = this.neighbours).northWest && !_.north && (f.beginPath(), T(c, $ - g, c + g, $ - g, c + g, $), f.lineTo(c, $), f.closePath(), P()), _.northWest && !_.west && (f.beginPath(), T(c - g, $, c - g, $ + g, c, $ + g), f.lineTo(c, $), f.closePath(), P()), _.northEast && !_.north && (f.beginPath(), T(c + d, $ - g, c + d - g, $ - g, c + d - g, $), f.lineTo(c + d, $), f.closePath(), P()), _.northEast && !_.east && (f.beginPath(), T(c + d + g, $, c + d + g, $ + g, c + d, $ + g), f.lineTo(c + d, $), f.closePath(), P()))
        }
    }
    ...
    function T(t, e, i, s, h, o) {
        let n = t - i,
            ...
            c = n * n + l * l,
            $ = c + n * a + l * r,
            d = 4 / 3 * (Math.sqrt(2 * c * $) - $) / (n * r - l * a),
            u = i + n - d * l;
        f.lineTo(t, e), isNaN(u) || f.bezierCurveTo(u, s + l + d * n, i + a + d * r, s + r - d * a, h, o)
    }(function i() {
        a = [], $ = 0, d = 0, g = 0, r = Math.ceil(e[0] / t.cellWidth * t.scaleDownGraphics), c = Math.ceil(e[1] / t.cellHeight * t.scaleDownGraphics);
        for (let s = 0; s < r; s++) {
            ...
            for (let o = 0; o < c; o++) {
                ...
                if ("Random" == t.cellAddType) Math.random() > t.randomPercent / 100 ? u.active = !1 : $++, a.push(u);
                else if ("Noise" === t.cellAddType) {
                    let _ = b.noise2D(h * t.scaleNoise, n * t.scaleNoise);
                    _ > t.minNoise && _ < t.maxNoise ? $++ : u.active = !1, a.push(u)
