! function () {
    ...
    class m {
        ...
        show() {
            ...
            this.active && (e = (this.x - l) * h, i = this.y * h + n, s = this.w * h, o = this.h * h, a = t.cornerRadius / t.scaleDownGraphics * h, r = this.neighbours, p.beginPath(), r.west || r.north || r.northWest && !r.north && !r.west ? T(e, i, s, o, 0, 0) : T(e, i, s, o, a, 0), r.east || r.north || r.northEast && !r.north && !r.east ? T(e, i, s, o, 0, 1) : T(e, i, s, o, a, 1), r.east || r.south || r.southEast && !r.south && !r.east ? T(e, i, s, o, 0, 2) : T(e, i, s, o, a, 2), r.west || r.south || r.southWest && !r.south && !r.west ? T(e, i, s, o, 0, 3) : T(e, i, s, o, a, 3), r.west || r.north || r.northWest && !r.north && !r.west ? p.lineTo(e, i) : p.lineTo(e, i + a), p.closePath(), P(), c = (this.x - l) * h, $ = this.y * h + n, d = this.w * h, g = this.h * h, u = t.connectionRadius / t.scaleDownGraphics * h, (f = this.neighbours).northWest && !f.north && (p.beginPath(), W(c, $ - u, c + u, $ - u, c + u, $), p.lineTo(c, $), p.closePath(), P()), f.northWest && !f.west && (p.beginPath(), W(c - u, $, c - u, $ + u, c, $ + u), p.lineTo(c, $), p.closePath(), P()), f.northEast && !f.north && (p.beginPath(), W(c + d, $ - u, c + d - u, $ - u, c + d - u, $), p.lineTo(c + d, $), p.closePath(), P()), f.northEast && !f.east && (p.beginPath(), W(c + d + u, $, c + d + u, $ + u, c + d, $ + u), p.lineTo(c + d, $), p.closePath(), P()))
        }
    }
